...
const locations: Location[] = [
  ...
  {
    id: "Qamru-Baugh",
    name: "Qamru Baugh (Najmi Zone)",
    description: "Religious center and community services",
    distance: "750m from Central Zone",
    icon: "location_on",
    query: "Qamru Baugh, Ujjain, Madhya Pradesh, India"
  },
  {
    id: "Burhani-Hall",
    name: "Burhani Hall (Najmi Zone)",
    description: "Burhani Hall Mawaid",
    distance: "400 m From Central Zone",
    icon: "location_on",
    query: "Burhani Hall, Ujjain, Madhya Pradesh, India"
  },
  {
    id: "safiee-masjid",
    name: "Safiee Masjid (Saifee Zone)",
    description: "Religious center and community services",
  ...
  {
    id: "taiyebi-masjid",
    name: "Taiyebi Masjid (Tayebi Zone)",
  ...
  {
    id: "ibrahimi-pura",
    name: "Ibrahimi Pura (Ibrahim Zone)",
    description: "Religious center and prayer facility",
  ...
  {
    id: "hasanji-badsha",
    name: "Hakimi Mohalla (Hakimi Zone)",
    description: "Religious center and prayer facility",
  ...
  {
    id: "Dosi-ai-saheba-qabrastan",
    name: "Dosi ai Saheba Qabrastan",
    description: "Community burial ground",
  ...
  },
  {
    ...
    distance: "2 km from Central Zone",
    icon: "train",
    query: "ujjain Railway Station, Ujjain, Madhya Pradesh, India"
  },
  {
    id: "ujjain-bus-stand",
    name: "Ujjain Bus Stand",
    description: "Main bus terminal in Ujjain",
    distance: "1.5 km from Central Zone",
    icon: "directions_bus",
    query: "Ujjain Bus Stand, Ujjain, Madhya Pradesh, India"
  },
